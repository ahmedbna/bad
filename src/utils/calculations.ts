...
function intersectLinePolyline(
  ...
  for (let i = 1; i < polyline.points.length; i++) {
    const lineSegment: Doc<'shapes'> = {
      ...
      layerId: `temp-lyr-${Date.now()}` as Id<'layers'>,
      type: 'line',
 ...
 */
export const calculateRectangleProperties = (
  p1: Point,
  p2: Point
): ShapeProperties => {
 ...
 */
export const calculateCircleProperties = (radius: number): ShapeProperties => {
 ...
 */
export const calculateEllipseProperties = (
  radiusX: number,
  radiusY: number,
 ...
 */
export const calculatePolygonProperties = (
  radius: number,
  sides: number
): ShapeProperties => {
 ...
 */
export const calculatePolylineProperties = (
  points: Point[]
): ShapeProperties => {
  let perimeter = 0;
  let area = 0;
 ...
 */
export const calculateArcProperties = (
  center: Point,
  radius: number,
  startAngle: number,
  endAngle: number
 ...
 */
export const calculateSplineProperties = (
  points: Point[],
  tension: number
): ShapeProperties => {
